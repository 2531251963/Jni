...
/**
 * @ClassName NativeLoader
 * @Description https://www.cnblogs.com/FlyingPuPu/p/7598098.html
 * @Author Liyihe
 * @Date 19-6-9 上午12:35
 * @Version 1.0
 */
public class NativeLoader {
     ...
     */
    public synchronized static void loader(String dirPath){
        try {
    ...
    private static void loadFileNative(File file, String ext) {
        ...
        if (file.getName().endsWith(ext)) {
            try {
                String p=java.net.URLDecoder.decode(file.getPath(), "utf-8");
                System.load(p);
